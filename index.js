...
http.createServer((req,res)=>{   //here creating a server this is Es5 version
 ...
 res.write("HELLO Iron Man");  //here sending response backend to frontend here also send any type like json and html file

res.write("<h1>HELLO Thanos</h1>") //send data in html formate

res.write(JSON.stringify({name:"amit",age:22}))  //send data  in json formate
